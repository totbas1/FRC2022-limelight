...
public class LimeLight{
  ...
  public static boolean limelightTrackTarget() {
    if(limelightTrackingX() == 0.0){
      if(RobotContainer.limelightRotateEncoder.getDistance() >= (LimeLight.calcHoodAngle()-3) && (RobotContainer.limelightRotateEncoder.getDistance()) <= (LimeLight.calcHoodAngle()+3)){
        return true;
      }
