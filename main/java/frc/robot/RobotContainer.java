...
public class RobotContainer {
  ...
  public static DigitalInput hoodLimitSwitch = new DigitalInput(AutoConstants.hoodLimitSwitchPort);
...
//  }
  ...
  private void configureButtonBindings() {
    new JoystickButton(m_driverController2, XboxController.Button.kB.value).whileHeld(m_ClimbingUpCommand);
    new JoystickButton(m_driverController2, XboxController.Button.kX.value).whileHeld(m_ClimbingDownCommand);
    ...
    new JoystickButton(m_driverController2, XboxController.Button.kY.value).whileHeld(m_ElevatorMoveTopCommand);
    new JoystickButton(m_driverController, XboxController.Button.kLeftBumper.value).whileHeld(m_ElevatorMoveBottomCommand);
    new JoystickButton(m_driverController, XboxController.Button.kX.value).whileHeld(m_ShootingRotateCommand);
    new JoystickButton(m_driverController2, XboxController.Button.kA.value).whileHeld(m_BallOutCommand);
